...
public interface EasyFlowTaskRepository extends CrudRepository<EasyFlowTask, String> {
	...
	@Query(nativeQuery = true, name = "test", value = "select  " + "ef_task.id " + ",ef_task.instance_id "
			...
			+ ",CAST(  ef_instance.flow ->> '$.formUrl' as char) as formUrl " + ",ef_instance.create_by " + ",ef_task.create_time "
	...
	List<Tuple> findByAssignmentAndInstanceIdInOrderByCreateTimeDesc(Integer assignment,
